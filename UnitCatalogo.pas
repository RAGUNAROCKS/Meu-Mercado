...
begin
    if NOT assigned(FrmProduto) then
      ...
      FrmProduto.Id_mercado := FrmCatalogo.Id_mercado;
...
procedure TFrmCatalogo.ImgCarrinhoClick(Sender: TObject);
begin
  ...
  begin
     ...
     begin
        ...
        begin
           ...
           LblPreco.Text := 'Compra Mínima: ' + FormatFloat('R$#,##0.00',fieldbyname('vl_compra_min').asfloat);
        end);
     end;
